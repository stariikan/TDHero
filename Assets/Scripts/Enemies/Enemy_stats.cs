...
public class Enemy_stats : MonoBehaviour
{
    ...
    public void RecoveryAfterEffects()
    {
        ...
        if (isTagChanged == true)
        {
            ...
            {
                tag = enemyStarterTag;
                this.gameObject.GetComponent<Enemy_movement>().ReturnTag();
                isTagChanged = false;
            }
        }
        if (isPoisoned == true)
    ...
    {
        isTagChanged = true;
        if (CompareTag("Enemy") && enemyStarterTag == "Enemy")
        {
            tag = "Flying_Enemy";
            this.gameObject.GetComponent<Enemy_movement>().ChangeTag();
        }

        else if (CompareTag("Flying_Enemy") && enemyStarterTag == "Flying_Enemy")
        {
            tag = "Enemy";
            this.gameObject.GetComponent<Enemy_movement>().ChangeTag();
        }
